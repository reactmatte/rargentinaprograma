...
function CALCULAR_PROMEDIO_EN_ARRAY(){
    ...
    for (let i = 0; i < EL_ARRAY.length; i++) {
        ...
        ACUMULADOR = ACUMULADOR + EL_ARRAY[i];
        
    }
    console.log(`Elementos del arreglo: ${EL_ARRAY}`)
    console.log(`La cantidad de elementos en el arreglo es: ${EL_ARRAY.length}`)
    console.log(`La suma de los elementos del arreglo es: ${ACUMULADOR}`)
    console.log(`El promedio en el arreglo es: ${ACUMULADOR / EL_ARRAY.length}`)
}
