...
console.log(nuestroTitulo) //<h1>Hola!</h1>
/*
...
for (let index = 0; index < mediaLinks.length; index++) {
    ...
    const elemento = mediaLinks[index].innerText
    console.log(elemento) //aca veo que texto tiene CADA uno de los elementos
}
...
const nuestroTituloText = nuestroTitulo.innerText
console.log(nuestroTituloText) //Hola!
...
nuestroTitulo.textContent = `Hola bellezes` //funciona!
...
const nuestroTwitter = document.querySelector(`.twitter`)
nuestroTwitter.id = "sorpresa" //funciona, le agrega un id #sorpresa al div>ul>li .twitter #sorpresa
...
const facebookColor = document.querySelector("body > footer > div:nth-child(3) > ul:nth-child(1) > li.facebook")
facebookColor.style.backgroundColor = `black`; //cambio el color fondo de facebook, el texto permanece en blanco
...
const textoParrafo = document.createTextNode('textoParrafo es un nodo de texto, hijo de nuevoParrafo');
    nuevoParrafo.appendChild(textoParrafo);
    nodoPagina.appendChild(nuevoParrafo);
